...
public class ChartController {
    ...
    public BaseResponse<Boolean> updatePost(@RequestBody ChartUpdateRequest chartUpdateRequest) {
    ...
    public BaseResponse<BiResponse> genChartByAi(@RequestPart("file") MultipartFile multipartFile,
        ...
        // 如果文件大小大于1M，就抛出异常，并给出提示
        final long ONE_MB = 1024 * 1024L;
        ThrowUtils.throwIf(size > ONE_MB, ErrorCode.PARAMS_ERROR, "文件超过1M");
        // 验证文件后缀
        String suffix= FileUtil.getSuffix(originalFilename);
        final List<String> ALLOW_SUFFIX = Arrays.asList("png", "jpg", "jpeg", "svg", "webp");
        ThrowUtils.throwIf(!ALLOW_SUFFIX.contains(suffix), ErrorCode.PARAMS_ERROR, "文件格式不支持");
